...
export const skillGroups = [
  {
    ...
    items: ['Angular', 'TypeScript', 'JavaScript', 'NgRx', 'SSR', 'Vue.js', 'Quasar Framework'],
  },
  {
    title: 'Backend',
  ...
  },
  {
    ...
    items: ['Azure Functions', 'Azure DevOps', 'CI/CD', 'Docker', 'Git', 'GitHub', 'TFS', 'TortoiseSVN'],
  },
  {
    title: 'Datos, integraciones y reportes',
    items: ['SQL Server', 'MySQL', 'Stored Procedures', 'REST APIs', 'SOAP', 'XML', 'JSON', 'TXT', 'CSV', 'Crystal Reports', 'Jasper Studio'],
  },
];
...
export const experiences: Experience[] = [
  {
    ...
    technologies: ['Angular', 'TypeScript', '.NET', 'Azure Functions', 'SQL Server', 'REST APIs'],
  },
  {
    company: 'SUPERCARNES JH',
    role: 'Desarrollador de Software',
    period: '10 agosto 2020 - Actualidad',
    location: 'Colombia',
    highlights: [
    ...
    technologies: ['PHP', 'Laravel', 'Vue.js', 'Quasar Framework', 'SQL Server', 'MySQL'],
  },
  {
    ...
    technologies: ['C#', 'JavaScript', 'AngularJS', 'WPF', 'SQL Server', 'REST', 'SOAP'],
  },
];
...
export const timeline: TimelineItem[] = [
  {
    ...
    description: 'Backend, frontend e interfaces de datos para sistemas corporativos.',
  },
  {
    date: '2020',
    title: 'Software operacional y reportes',
    description: 'Soluciones de gestión, datos, reportes y facturación electrónica.',
  },
  {
    date: '2023',
    title: 'Entornos enterprise',
    description: 'Desarrollo con Angular, .NET, Azure Functions y SQL Server en equipos empresariales.',
  },
  {
    date: 'Actualidad',
    title: 'Frontend senior y full stack',
    description: 'Foco en interfaces mantenibles, integraciones y evolución de sistemas corporativos.',
  },
];
